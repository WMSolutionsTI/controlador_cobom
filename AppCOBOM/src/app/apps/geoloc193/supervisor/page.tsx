...
export default function GeolocSupervisorPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Estatísticas GeoLoc193</h1>
          <p className="text-muted-foreground">
            Visão geral de todas as solicitações e atendentes
          </p>
        </div>
        <div className="flex gap-2">
          <Button onClick={() => router.push("/apps/geoloc193/supervisor/arquivadas")} variant="outline" size="sm">
